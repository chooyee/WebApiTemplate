...
namespace Factory.Infra
{
    public class Utilities
    {
        ...
        //public static object GetFilepathInfo(string filePath, int i = 1)
        //{
        //    string directoryPath = Path.GetDirectoryName(filePath);
        //    string fileName = Path.GetFileNameWithoutExtension(filePath);
        //    string fileExtension = Path.GetExtension(filePath);

        //    return new { directoryPath, fileName, fileExtension };
        //}

        public static FileStruct GetFilepathInfo(string filePath)
        {
            string directoryPath = Path.GetDirectoryName(filePath);
            string fileName = Path.GetFileNameWithoutExtension(filePath);
            string fileExtension = Path.GetExtension(filePath);

            return new FileStruct( directoryPath, fileName, fileExtension );
        }
        ...
        //public static List<string> Striper(string inputText)
        //{
